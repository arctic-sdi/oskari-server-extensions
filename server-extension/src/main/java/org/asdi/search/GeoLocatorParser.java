...
public class GeoLocatorParser {
    ...
    private GeoLocatorSearchChannel channel;
    private GeoLocatorCountries countries = null;

    private String serviceSrs = "EPSG:4258";

    public GeoLocatorParser(GeoLocatorSearchChannel elfchannel) {
        this(null, elfchannel);
    }
    public GeoLocatorParser(final String serviceSrs, GeoLocatorSearchChannel elfchannel) {
        ...
        channel = elfchannel;
        countries = GeoLocatorCountries.getInstance();
