...
INSERT INTO oskari_users_roles(user_id, role_id) VALUES((SELECT id FROM oskari_users WHERE user_name = 'admin'), (SELECT id FROM oskari_roles WHERE name = 'Arcticsdi'));
...
INSERT INTO oskari_users_roles(user_id, role_id) VALUES((SELECT id FROM oskari_users WHERE user_name = 'Arcticsdi'), (SELECT id FROM oskari_roles WHERE name = 'Arcticsdi'));
